  ...
  return (
    <motion.section className="relative py-20 bg-primary " 
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p>
          I am a <span className="gradient-3">graduate in Electronics and Communications</span> in 2024, with a <span className="gradient-3">Postgraduate Program vocational specialization</span> in <span className="gradient-3">Applied Generative AI</span> from <span className="gradient-3">Purdue University</span>. I have developed a <span className="gradient-5">strong foundation in artificial intelligence (AI) and machine learning (ML)</span>, built through <span className="gradient-5">hands-on projects, internships</span>, and <span className="gradient-5">advanced coursework</span>.
        </p>
        <p>
